...
var SemanticWebServiceAgent = /** @class */ (function (_super) {
    ...
    function SemanticWebServiceAgent(context) {
        var _this = _super.call(this, context, { name: "searchLocation", uri: function (args) { return _this.formatUri("/api/SemanticWeb/SearchLocation", args); } }, { name: "search", uri: function (args) { return _this.formatUri("/api/SemanticWeb/Search", args); } }, { name: "getDetails", uri: function (args) { return _this.formatUri("/api/SemanticWeb/GetDetailsGeotool/", [args[0], args[1]], { latitude: args[2].latitude, longitude: args[2].longitude, isBulkUpload: args[3], proposalBulkId: args[4] }); } }, { name: "getBulkDetails", uri: function (args) { return _this.formatUri("/api/SemanticWeb/GetBulkDetails", [args[0], args[1]]); } }, { name: "GeocodeAddress", uri: function (args) { return _this.formatUri("/api/SemanticWeb/GeocodeAddress", args); } }, { name: "Geocode", uri: function (args) { return _this.formatUri("/api/SemanticWeb/Geocode", [args[0], args[1], args[2]]); } }, { name: "GeocodeLocationFile", method: "POST", uri: "/api/SemanticWeb/Geocode/File", body: function (args) { return args[0]; } }, { name: "getInsightRadius", uri: function (args) { return _this.formatUri("/api/SemanticWeb/GetInsightRadius", args); } }) || this;
        if (dev.fakeSemanticWeb) {
            ...
            _this.getDetails = function () { return Promise.resolve(JSON.parse('{"Url":"https://maps.google.com/?cid=10554007608722651515", "Website": "http://www.anemaecozze.com/", "PhoneNumber": "02 331 9260", "PotentialUsers": 0, "MaleStats": 0, "MaleStatsPercentage": 0, "MaleStatsAverageAge": 0, "FemaleStats": 0, "FemaleStatsPercentage": 0, "FemaleStatsAverageAge": 0, "BugdetMinValue": 0, "BugdetMaxValue": 0, "PublicOfficesNumber": 0, "PrivatesNumber": 0, "PublicTransportNumber": 0, "Radius": 0, "Tracing": null, "Population": 0, "Cluster": 0, "Ranking": null, "Address": "Corso Sempione, 41, 20145 Milano MI", "Geometry": { "location": { "lat": 45.48119519999999, "lng": 9.164418999999999 } }, "ID": "ChIJrSyOcxXBhkcRe_muqgBed5I", "Name": "Anema e Cozze", "Categories": [{ "Category": "restaurant", "Description": null, "Score": 0, "Competitors": 0 }, { "Category": "food", "Description": null, "Score": 0, "Competitors": 0 }, { "Category": "point_of_interest", "Description": null, "Score": 0, "Competitors": 0 }, { "Category": "establishment", "Description": null, "Score": 0, "Competitors": 0}]}')); };
        }
        if (dev.fakeGeocodeAddress) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = this.userSession;
                        return [4 /*yield*/, this.userSession.InsightRadiusAsync(item.Geometry.location)];
                    case 2:
